# -*- encoding: utf-8 -*-
# stub: rails 5.0.0.beta1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activemodel>, ["= 5.0.0.beta1"])
      s.add_runtime_dependency(%q<activerecord>, ["= 5.0.0.beta1"])
      s.add_runtime_dependency(%q<actionmailer>, ["= 5.0.0.beta1"])
      s.add_runtime_dependency(%q<activejob>, ["= 5.0.0.beta1"])
      s.add_runtime_dependency(%q<actioncable>, ["= 5.0.0.beta1"])
      s.add_runtime_dependency(%q<railties>, ["= 5.0.0.beta1"])
      ...
      s.add_dependency(%q<actionmailer>, ["= 5.0.0.beta1"])
      s.add_dependency(%q<activejob>, ["= 5.0.0.beta1"])
      s.add_dependency(%q<actioncable>, ["= 5.0.0.beta1"])
      s.add_dependency(%q<railties>, ["= 5.0.0.beta1"])
